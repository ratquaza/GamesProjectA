...
public class ManaBubble : MonoBehaviour
{
    ...
    protected void OnPop()
    {
        ...
        foreach (var hit in hits)
        {
            ...
            ManaBubble bubble = hit.GetComponent<ManaBubble>();
    ...
    {
        if (isReady && collision.collider.GetComponent<ManaBubble>() == null) isPopping = true;
    }
